...
| [TwitchIO-Stable.md](./API/External/TwitchIO-Stable.md) | TwitchIO **3.3.2** stable - `./bot/beta-v6.py`. `commands.AutoBot`, full EventSub/events/commands/PartialUser tables, Conduits, 2.10→3.x migration map, changelog 3.1–3.3.2, project dual EventSub mapping. | 1068 |
| [patreon.md](./API/External/patreon.md) | Patreon Webhooks v2 - event types, JSON:API payload schema, HMAC-MD5 verification (not yet enforced), live overlay visual alerts (pledge/update/cancelled). | 562 |
| [kofi.md](./API/External/kofi.md) | Ko-fi webhooks - Donation/Subscription/Commission/Shop Order schemas, form-encoded body, `verification_token` in-body check (not yet enforced), live overlay visual alerts. | 338 |
| [fourthwall.md](./API/External/fourthwall.md) | Fourthwall webhooks - ORDER_PLACED/DONATION/SUBSCRIPTION_PURCHASED/GIFT_PURCHASE schemas, HMAC-SHA256 verification (not yet enforced), live overlay visual alerts. | 647 |
