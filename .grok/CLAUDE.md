...
Short, enforceable rules live in `./rules/`. Check the relevant one before making changes:

- **[bot-versions.md](./rules/bot-versions.md)** - Stable/beta/v6 policy, when to edit which file
- **[paths.md](./rules/paths.md)** - `./` for repo paths, server paths labeled separately
- **[data-flow.md](./rules/data-flow.md)** - WebSocket vs API vs direct DB decision
- **[database.md](./rules/database.md)** - `website` vs per-user DB scoping, async aiomysql
- **[secrets.md](./rules/secrets.md)** - No hardcoded credentials, signature verification
- **[php-config.md](./rules/php-config.md)** - **HARD RULE:** PHP never reads `.env`; always uses `./config/{service}.php`
- **[overlays.md](./rules/overlays.md)** - Browser-source constraints, queueing, auto-reconnect

## Memory Files (Architecture Reference)

Detailed system documentation lives in `./memory/`:

- **[system_bot.md](./memory/system_bot.md)** - Twitch chat bot (3 versions: stable/beta/v6)
  - Use this when: adding bot commands, modifying event handling, integrating external services
  
- **[system_api.md](./memory/system_api.md)** - FastAPI data server (HTTPS, port 443)
  - Use this when: adding/modifying endpoints, handling authentication, managing databases
  
- **[system_websocket.md](./memory/system_websocket.md)** - Real-time event hub (SocketIO, port 443)
  - Use this when: adding new event types, modifying broadcasters, working with handlers
  
- **[system_secondary.md](./memory/system_secondary.md)** - Dashboard, overlays, stream server, extension
...
1. Read [system_bot.md](./memory/system_bot.md) - Command System section
...
1. Read [system_api.md](./memory/system_api.md) - API Endpoints section
...
1. Read [system_websocket.md](./memory/system_websocket.md) - Event Types section
...
1. Read [system_secondary.md](./memory/system_secondary.md) - Overlay System section
...
1. Read [system_secondary.md](./memory/system_secondary.md) - Stream System section
...
**Memory Files**: See `./memory/MEMORY.md`
