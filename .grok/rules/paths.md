...
6. **Help docs live in `./support/`.** The old `./help/` tree was removed (2026-08-26). `help.botofthespecter.com` 308s to `support.botofthespecter.com`. Do not recreate `./help/`.
