...
- [Grok SSH key](project_grok_ssh_key.md) — operator Ed25519 key; SSH by IP (`ssh bots` / `api` / `websocket` / `sql` / `sql-new` / `web`)
- [New SQL host](project_sql_new_host.md) — production MySQL is `150.107.75.252`; old box still up as backup
