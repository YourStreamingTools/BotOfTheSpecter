...
- [Grok SSH key](project_grok_ssh_key.md) — operator Ed25519 key; SSH by public IP (`ssh bots` / `api` / `websocket` / `sql` / `web` / `stream-syd`)
- [SQL host](project_sql_new_host.md) — production MySQL is `150.107.75.252` only; no backup SQL box
