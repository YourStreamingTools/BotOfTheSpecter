...
<body>
    <header class="hero is-primary">
        <div class="hero-body">
            <div class="container">
                ...
                <a href="https://dashboard.botofthespecter.com/" class="button is-light is-outlined">LOGIN</a>
            </div>
        </div>
    </header>
    <div class="container mt-6">
        <div class="content">
            <section>
                <h2 class="title">Enhance Your Twitch and Discord Experience</h2>
                <ul>
            ...
            <section>
                <h2 class="title">Tailored for Streamers and Server Owners</h2>
