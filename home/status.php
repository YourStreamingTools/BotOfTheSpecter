...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info { margin: 10px 0; font-size: 1.5em; }
        .heartbeat-container { display: flex; align-items: center; font-size: 1.5em; margin-bottom: 20px; }
        .heartbeat { font-size: 1.5em; color: #ff4d4d; transition: transform 0.2s ease; }
