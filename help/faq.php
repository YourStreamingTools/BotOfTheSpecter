...
<p class="subtitle has-text-light">Common questions and answers about BotOfTheSpecter</p>
    <div class="content has-text-light">
        <h2 class="title is-4 has-text-light">Frequently Asked Questions</h2>
        <div class="columns is-multiline is-flex">
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">What built-in commands are there for the bot?</h3><br><br>
            ...
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">How do I set up audio monitoring in OBS?</h3><br><br>
            ...
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">I'm having trouble with the bot. What should I do?</h3><br><br>
            ...
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">How do I use custom command variables?</h3><br><br>
            ...
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">How do Twitch Channel Points work with the bot?</h3><br><br>
            ...
            <div class="column is-6">
                <div class="box has-background-dark has-text-light mb-4 is-flex" style="border: 1px solid rgba(255, 255, 255, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; cursor: pointer; height: 100%;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 25px rgba(255,255,255,0.1)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 3px rgba(10,10,10,0.1), 0 0 0 1px rgba(10,10,10,0.1)';">
                    <h3 class="title is-5 has-text-light">I want to do something custom with my commands, what can I do?</h3><br><br>
        ...
        <p class="has-text-light">
            As we receive more questions from our community, we'll continue to add them to this FAQ page with detailed answers.
        </p>
    </div>
