...
ob_start();
?>
<nav class="breadcrumb has-arrow-separator has-text-light" aria-label="breadcrumbs" style="margin-bottom: 2rem; background-color: rgba(255, 255, 255, 0.05); padding: 0.75rem 1rem; border-radius: 6px; border: 1px solid rgba(255, 255, 255, 0.1); --breadcrumb-separator: '→'; --breadcrumb-separator-color: #fff;">
    <ul>
        <li><a href="troubleshooting.php" class="has-text-light">Troubleshooting Guide</a></li>
        <li class="is-active"><a aria-current="page" class="has-text-light">OBS Audio Monitoring Setup</a></li>
    </ul>
</nav>
...
<div class="content has-text-light">
    ...
    <ol>
        ...
        <li><strong>Go to Settings:</strong> Click on the "Settings" button in the bottom-right corner of the OBS window.<br><img src="img/OBS_Audio_Monitoring/Settings_Button.png" alt="OBS Settings Button" style="max-width: 100%; height: auto;"></li>
        <li><strong>Select the Audio Tab:</strong> In the settings window, click on the "Audio" tab.<br><img src="img/OBS_Audio_Monitoring/Access_Audio_Settings.png" alt="Access Audio Settings in OBS" style="max-width: 100%; height: auto;"></li>
        <li><strong>Configure Monitoring Device:</strong><br><img src="img/OBS_Audio_Monitoring/Configure_Monitoring_Device.png" alt="Configure Monitoring Device in OBS" style="max-width: 100%; height: auto;">
            <ul>
        ...
        <li><strong>Add Browser Source for Overlay:</strong>
            <ul>
                <li>Go to the Sources box in OBS and click the "+" icon to add a new source, then select "Browser".<br><img src="img/OBS_Audio_Monitoring_and_Output/Add_New_Source.png" alt="Add New Source in OBS" style="max-width: 100%; height: auto;"><br><img src="img/OBS_Audio_Monitoring_and_Output/Add_New_Source_Browser.png" alt="Select Browser Source in OBS" style="max-width: 100%; height: auto;"></li>
                <li>When the Create/Select Source window opens, select "Create new" and name it anything you like (e.g., "Specter Overlay").<br><img src="img/OBS_Audio_Monitoring_and_Output/Add_New_Source_Browser_Name_Setting.png" alt="Create New Browser Source in OBS" style="max-width: 100%; height: auto;"></li>
                <li>Ensure "Make source visible" is checked and click "OK".</li>
                <li>When the Properties window for the Browser source appears, enter the correct overlay URL in the URL input box: <code>https://overlay.botofthespecter.com/alert.php?code=YOUR_API_KEY</code><br><img src="img/OBS_Audio_Monitoring_and_Output/Add_New_Source_Broswer_Properties_Window.png" alt="Browser Source Properties Window in OBS" style="max-width: 100%; height: auto;"></li>
        ...
        <li><strong>Configure Audio Monitoring for the Overlay Source:</strong>
            <ul>
                <li>After clicking OK, the browser source will appear in your Audio Mixer at the bottom of the OBS window.<br><img src="img/OBS_Audio_Monitoring_and_Output/Broswer_Source_Audio_Mixer.png" alt="Browser Source in OBS Audio Mixer" style="max-width: 100%; height: auto;"></li>
                <li>Click the three dots (⋯) next to the speaker icon for the browser source.<br><img src="img/OBS_Audio_Monitoring_and_Output/Broswer_Source_Audio_Mixer_Advanced_Audio_Properties.png" alt="Advanced Audio Properties Menu in OBS" style="max-width: 100%; height: auto;"></li>
                <li>In the dropdown menu, click "Advanced Audio Properties".</li>
                <li>When the Advanced Audio Properties window opens, click on the dropdown menu next to "Audio Monitoring" and set it to "Monitor and Output".<br><img src="img/OBS_Audio_Monitoring_and_Output/Advanced_Audio_Properties_Window.png" alt="Advanced Audio Properties Window in OBS" style="max-width: 100%; height: auto;"><br><img src="img/OBS_Audio_Monitoring_and_Output/Advanced_Audio_Properties_Window_Saved.png" alt="Advanced Audio Properties Window with Monitor and Output Selected" style="max-width: 100%; height: auto;"></li>
