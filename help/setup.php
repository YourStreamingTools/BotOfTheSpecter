...
<div class="content has-text-light">
    ...
    <div class="box has-background-dark has-text-light">
        <p>The bot needs to be a moderator in your channel to function properly. There are now two ways to do this:</p>
        <h4 class="title is-5 has-text-light">Option 1 (Recommended): Use the dashboard button</h4>
        <p>When you're logged into the BotOfTheSpecter dashboard and the bot is not modded, you should see this warning:</p>
        <p><code>The bot is not a moderator on your channel. Please make the bot a moderator to start it.</code></p>
        <p>Click the <span class="has-text-weight-bold">Make Mod</span> button and follow the prompt.</p>
        <h4 class="title is-5 has-text-light mt-4">Option 2: Add the role manually on Twitch</h4>
        <ol>
    ...
    <h2 class="title is-3 has-text-light" id="channel-setup">
        ...
        Step 4: Continue in Dashboard & Configure
    </h2>
    <div class="box has-background-dark has-text-light">
        <p>Now that the bot has moderator permissions on Twitch, continue with configuration in the BotOfTheSpecter dashboard:</p>
        <ul>
            <li>If you used <span class="has-text-weight-bold">Option 1 (Make Mod)</span> in Step 3, you're already in the right place and can continue immediately.</li>
            <li>If you used <span class="has-text-weight-bold">Option 2 (manual Twitch Roles Manager)</span>, return to the dashboard and refresh/log out and back in so permissions update.</li>
        </ul>
    ...
    <div class="box has-background-dark has-text-light">
        ...
        <p>Once you're in the dashboard, review these core settings:</p>
        <ul>
            <li><span class="has-text-weight-bold">Bot Status:</span> After the bot is modded, the dashboard should detect it automatically. If you still see a warning, refresh the page or log out and back in. Click <span class="has-text-weight-bold">START</span> to run the bot, then wait for the status to update.</li>
            ...
            <li><span class="has-text-weight-bold">Command Prefix:</span> Commands use <code>!</code> and this prefix cannot be changed.</li>
        </ul>
        <div class="notification is-info has-background-dark has-text-light" style="margin-top: 1rem;">
            <h5 class="title is-5 has-text-light" style="margin-bottom: 0.75rem;">
                <span class="icon has-text-info">
                    <i class="fas fa-gamepad"></i>
                </span>
                <span>Control Your Bot</span>
            </h5>
            <p class="has-text-light" style="margin-bottom: 0.75rem;">
                BotOfTheSpecter is designed with control in mind - <span class="has-text-weight-bold">you run the bot, you stop the bot</span>.
            </p>
            <p class="has-text-light" style="margin-bottom: 0.75rem;">
                If you no longer wish to use the bot, simply <span class="has-text-weight-bold">STOP Specter</span> with the STOP button. It's that simple.
            </p>
            <p class="has-text-light" style="margin-bottom: 0.75rem;">
                <span class="has-text-weight-bold">No company or system should tell you how to run your own stream</span> - and we don't want to do that.
            </p>
            <p class="has-text-light" style="margin-bottom: 0.75rem;">
            ...
            <p class="has-text-light" style="margin-bottom: 0; padding-left: 0.75rem; border-left: 3px solid rgba(66, 165, 245, 0.75);">
                <span class="has-text-weight-bold">As our developer has always said:</span><br>
                <em>"I built Specter so I'm not running 4 different chat bots on my own stream, now I just run one, that's Specter."</em>
            </p>
        </div>
    </div>
    <div class="box has-background-dark has-text-light">
    ...
    <div class="box has-background-dark has-text-light">
        <p>
            Bot Points are your built-in loyalty system. Viewers earn points as they chat and interact, and you can tune how rewards are given.<br>
            This feature is currently enabled by default (an on/off toggle is planned for a future update).
        </p>
        <ul>
            <li><span class="has-text-weight-bold">Point Name:</span> Choose a custom name for your points (for example, "Coins", "Tokens", or "Credits").</li>
            ...
            <li><span class="has-text-weight-bold">Subscriber Multipliers:</span> Add bonus multipliers for subscribers (for example, 2x points).</li>
        </ul>
        <div class="notification is-info has-background-dark has-text-light">
            <span class="has-text-weight-bold">Why set this up?</span><br>
                Bot Points help encourage chat activity and make your community feel more interactive.<br>
                As more point-based features roll out, you'll be able to use points for custom rewards, shoutouts, and other perks.
        </div>
        <div class="notification is-info has-background-dark has-text-light">
            <span class="has-text-weight-bold">API Integrations (Credit / Debit):</span><br>
            You can also manage user points through the API for custom integrations.
            <ul style="margin-top: 0.5rem;">
            ...
            <p style="margin-top: 0.5rem; margin-bottom: 0;">
                Docs: 
                <a href="https://api.botofthespecter.com/docs#/Commands/credit_user_points" target="_blank" class="has-text-link">credit_user_points</a>
                |
                <a href="https://api.botofthespecter.com/docs#/Commands/debit_user_points" target="_blank" class="has-text-link">debit_user_points</a>
            </p>
        </div>
    </div>
    ...
    <div class="box has-background-dark has-text-light">
        ...
        <p>Custom commands are one of the quickest ways to make your bot feel like part of your community. We recommend starting with simple commands for links and stream info, for example <code>!discord</code>, <code>!youtube</code>, <code>!instagram</code>, and <code>!business</code>.</p>
        <p>Create them on the <a href="https://dashboard.botofthespecter.com/custom_commands.php" target="_blank">Custom Commands page</a> on the Specter Dashboard.</p>
        <p>A good starter setup usually includes:</p>
        <ul>
            <li><span class="has-text-weight-bold">Community links:</span> Discord, social accounts, merch, and support links</li>
            <li><span class="has-text-weight-bold">Channel info:</span> Stream schedule, PC specs, and frequently asked questions</li>
            <li><span class="has-text-weight-bold">Utility commands:</span> Rules reminder, business email, and event announcements</li>
        </ul>
    ...
    <div class="box has-background-dark has-text-light">
        ...
        <p>Auto messages help keep important information visible without needing a moderator to post it manually. You can use them for reminders, links, sponsor mentions, or regular community prompts.</p>
        <p>Create them on the <a href="https://dashboard.botofthespecter.com/timed_messages.php" target="_blank">Timed Messages page</a> on the Specter Dashboard.</p>
        <p>Popular auto message ideas:</p>
        <ul>
            <li><span class="has-text-weight-bold">Welcome and rules:</span> Friendly reminders about chat rules and stream expectations</li>
            <li><span class="has-text-weight-bold">Useful links:</span> Discord invite, social links, donation links, and command list</li>
            <li><span class="has-text-weight-bold">Stream engagement:</span> Follow reminder, schedule updates, and community events</li>
        </ul>
        <p>Use a balanced schedule so messages are helpful but not repetitive. A slower timer with message-count triggers usually feels best for active chat.</p>
        <div class="notification is-info has-background-dark has-text-light" style="margin-top: 1rem;">
