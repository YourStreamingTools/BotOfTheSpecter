...
<body>
    ...
    .tag-multiselect .tms-suggestion { padding:0.5rem 0.75rem; cursor:pointer; color: #e0e0e0; border-bottom: 1px solid rgba(255,255,255,0.02); }
    .tag-multiselect .tms-suggestion:last-child { border-bottom: none; }
    .tag-multiselect .tms-suggestion:hover { background: rgba(255,255,255,0.02); color: #ffffff; }
    </style>
