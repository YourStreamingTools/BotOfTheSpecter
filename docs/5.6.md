...
* **Custom Variables for Custom Messages | PURPLE = Beta Bot Only**
...
## New Commands
* **`!obs`** - New moderator command for direct OBS integration using the Specter OBS Connector app, enabling control and interaction with OBS events.
