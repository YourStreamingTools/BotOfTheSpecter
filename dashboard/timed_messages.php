...
<div class="container">
    <h1 class="title"><?php echo "$greeting, $twitchDisplayName"; ?><img id="profile-image" class="round-image" src="<?php echo $twitch_profile_image_url; ?>" width="50px" height="50px" alt="<?php echo $twitchDisplayName; ?> Profile Image"></h1>
    <br>
