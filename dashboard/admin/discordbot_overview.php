...
<div class="sp-card">
    <div class="sp-card-header">
        <h1 class="sp-card-title"><span class="icon"><i class="fab fa-discord"></i></span> Discord Bot Configuration Overview</h1>
        <div class="sp-btn-group">
            <input id="user-search" class="sp-input" type="text" placeholder="Search users...">
            <a id="clear-search" class="sp-btn" title="Clear search">Clear</a>
        </div>
    </div>
    ...
    <p style="margin-bottom:1rem;">Overview of all users with Discord bot configuration. Click a user card to view full details.</p>
                ...
                <div class="discord-config-card config-card" data-username="<?php echo strtolower($safeUser); ?>" data-linked="<?php echo $isLinked ? '1' : '0'; ?>">
                    ...
                    <div class="discord-config-card-body">
                                ...
                                <?php if ($trackedCount > 0): ?>
                                    <p><strong>Tracked Streams:</strong> <span class="sp-badge sp-badge-blue"><?php echo $trackedCount; ?></span></p>
                                <?php endif; ?>
                                <?php 
                                    $enabledFeatures = [];
                    ...
                    <div class="discord-config-card-footer">
                        <a href="#" class="discord-config-card-footer-item view-config-btn" data-username="<?php echo htmlspecialchars($username); ?>">View Full Config</a>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openConfigModal(username) {
        ...
        // Basic Info
        html += '<h4 style="font-size:1rem;font-weight:700;margin:0.5rem 0;">Basic Information</h4>';
        html += '<table class="sp-table"><tbody>';
        html += `<tr><td><strong>Twitch Username</strong></td><td>${escapeHtml(config.username)}</td></tr>`;
        html += `<tr><td><strong>Discord Linked</strong></td><td><span class="sp-badge ${config.is_linked ? 'sp-badge-green' : 'sp-badge-amber'}">${config.is_linked ? 'Yes' : 'No'}</span></td></tr>`;
        if (config.discord_username) {
            html += `<tr><td><strong>Discord Username</strong></td><td>${escapeHtml(config.discord_username)}</td></tr>`;
        }
        html += '</tbody></table>';
        // Server Configuration
        html += '<h4 style="font-size:1rem;font-weight:700;margin:1rem 0 0.5rem;">Server Configuration</h4>';
        html += '<table class="sp-table"><tbody>';
        ...
        html += '<h4 style="font-size:1rem;font-weight:700;margin:1rem 0 0.5rem;">Stream Configuration</h4>';
        html += '<table class="sp-table"><tbody>';
        ...
        html += '</tbody></table>';
        // Other Channels
        html += '<h4 style="font-size:1rem;font-weight:700;margin:1rem 0 0.5rem;">Other Channels</h4>';
        html += '<table class="sp-table"><tbody>';
        ...
        if (config.tracked_streams && config.tracked_streams.length > 0) {
            html += '<h4 style="font-size:1rem;font-weight:700;margin:1rem 0 0.5rem;">Tracked Streams</h4>';
            html += '<table class="sp-table"><thead><tr><th>Username</th><th>Stream URL</th></tr></thead><tbody>';
        ...
        if (config.server_management_settings && Object.keys(config.server_management_settings).length > 0) {
            ...
            html += '<h4 style="font-size:1rem;font-weight:700;margin:1rem 0 0.5rem;">Server Management Settings</h4>';
            html += '<table class="sp-table"><tbody>';
            // Welcome Message Settings
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Welcome Message</strong></td></tr>`;
            ...
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Auto Role Assignment</strong></td></tr>`;
            ...
            // Message Tracking
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Message Tracking</strong></td></tr>`;
            ...
            // Role Tracking
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Role Tracking</strong></td></tr>`;
            ...
            // Role History
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Role History</strong></td></tr>`;
            ...
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Server Role Management</strong></td></tr>`;
            ...
            // User Tracking
            html += `<tr><td colspan="2"><strong class="sp-text-accent">User Tracking</strong></td></tr>`;
            ...
            // Reaction Roles
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Reaction Roles</strong></td></tr>`;
            ...
            // Rules Configuration
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Rules Configuration</strong></td></tr>`;
            ...
            // Stream Schedule
            html += `<tr><td colspan="2"><strong class="sp-text-accent">Stream Schedule</strong></td></tr>`;
