...
<?php if ($betaAccess) { ?>
  <p style='color: red;'>If you wish to start the Beta Version of the bot, please ensure that the Stable Bot is stopped first as this will cause two sets of data and will cause issues.</p>
<?php } ?>
