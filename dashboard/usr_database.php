    ...
    $tables = [
        ...
        'twitch_alerts' => "
            CREATE TABLE IF NOT EXISTS twitch_alerts (
                ...
                alert_condition VARCHAR(255) DEFAULT NULL,
                duration INT DEFAULT 8,
                animation_in VARCHAR(50) DEFAULT 'fadeIn',
                animation_out VARCHAR(50) DEFAULT 'fadeOut',
                animation_in_duration DECIMAL(3,1) DEFAULT 1.0,
                animation_out_duration DECIMAL(3,1) DEFAULT 1.0,
                layout_preset VARCHAR(20) DEFAULT 'above',
                bg_color VARCHAR(20) DEFAULT '#FFFFFF',
                bg_opacity INT DEFAULT 0,
                padding INT DEFAULT 16,
                gap INT DEFAULT 16,
                rounded_corners TINYINT(1) DEFAULT 1,
                drop_shadow TINYINT(1) DEFAULT 1,
                message_template TEXT DEFAULT NULL,
                font_family VARCHAR(100) DEFAULT 'Roboto',
                font_weight VARCHAR(20) DEFAULT 'Semi-Bold',
                font_size INT DEFAULT 24,
                text_alignment VARCHAR(20) DEFAULT 'center',
                text_vertical_alignment VARCHAR(20) DEFAULT 'center',
                text_color VARCHAR(20) DEFAULT '#FFFFFF',
                accent_color VARCHAR(20) DEFAULT '#A1C53A',
                text_drop_shadow TINYINT(1) DEFAULT 1,
                tts_enabled TINYINT(1) DEFAULT 0,
                alert_image VARCHAR(255) DEFAULT NULL,
                image_scale INT DEFAULT 100,
                image_volume INT DEFAULT 0,
                alert_sound VARCHAR(255) DEFAULT NULL,
                sound_volume INT DEFAULT 50,
                celebration_enabled TINYINT(1) DEFAULT 0,
