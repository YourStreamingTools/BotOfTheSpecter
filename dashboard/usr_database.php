...
try {
    ...
    $columns = [
        ...
        'highfive_counts' => ['username' => "VARCHAR(255)", 'highfive_count' => "INT DEFAULT 0"],
        'kiss_counts' => ['username' => "VARCHAR(255)", 'kiss_count' => "INT DEFAULT 0"],
        ...
        'bits_data' => ['id' => "INT PRIMARY KEY AUTO_INCREMENT", 'user_id' => "VARCHAR(255)", 'user_name' => "VARCHAR(255)", 'bits' => "INT", 'timestamp' => "DATETIME DEFAULT CURRENT_TIMESTAMP"],
        ...
        'channel_point_rewards' => ['reward_id' => "VARCHAR(255)", 'reward_title' => "VARCHAR(255)", 'reward_cost' => "VARCHAR(255)", 'custom_message' => "TEXT", 'usage_count' => "INT DEFAULT 0", 'managed_by' => "VARCHAR(50) DEFAULT 'twitch'"],
        ...
        'quote_category' => ['id' => "INT(11) NOT NULL AUTO_INCREMENT", 'quote_id' => "INT(11)", 'category_id' => "INT(11)"],
        'sound_alerts' => ['reward_id' => "VARCHAR(255) NOT NULL", 'sound_mapping' => "TEXT"],
        'twitch_sound_alerts' => ['twitch_alert_id' => "VARCHAR(255) NOT NULL", 'sound_mapping' => "TEXT"],
        'video_alerts' => ['reward_id' => "VARCHAR(255) NOT NULL", 'video_mapping' => "TEXT"],
        'joke_settings' => ['id' => "INT(11) NOT NULL AUTO_INCREMENT", 'blacklist' => "TEXT"],
        ...
        'subathon_settings' => ['id' => "INT PRIMARY KEY AUTO_INCREMENT", 'starting_minutes' => "INT DEFAULT NULL", 'cheer_add' => "INT DEFAULT NULL", 'sub_add_1' => "INT DEFAULT NULL", 'sub_add_2' => "INT DEFAULT NULL", 'sub_add_3' => "INT DEFAULT NULL", 'donation_add' => "INT DEFAULT NULL"],
        'tts_settings' => ['id' => "INT PRIMARY KEY AUTO_INCREMENT", 'voice' => "VARCHAR(50)", 'language' => "VARCHAR(10)"],
