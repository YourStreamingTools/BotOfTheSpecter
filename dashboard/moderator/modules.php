...
<div class="container">
    ...
    <?php if (isset($_SESSION['update_message'])): ?>
        <div class="notification is-success"><?php echo $_SESSION['update_message'];
...
<div id="jokeBlacklistModal" class="modal">
    ...
    <div class="modal-content" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('jokeBlacklistModal')"
        ...
        <div class="box">
            <form method="POST" action="module_data_post.php">
                ...
                <h2 class="subtitle is-4 has-text-danger" style="text-align: center;">Any category selected here will
                    not be allowed to be posted by the bot.</h2>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]"
                            value="Miscellaneous" <?php echo in_array("Miscellaneous", $current_blacklist) ? " checked" : ""; ?>> Miscellaneous</label></div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="Coding"
                            <?php echo in_array("Coding", $current_blacklist) ? " checked" : ""; ?>> Coding</label>
                </div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="Development"
                            <?php echo in_array("Development", $current_blacklist) ? " checked" : ""; ?>>
                        Development</label></div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="Halloween"
                            <?php echo in_array("Halloween", $current_blacklist) ? " checked" : ""; ?>>
                        Halloween</label></div>
                ...
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="religious"
                            <?php echo in_array("religious", $current_blacklist) ? " checked" : ""; ?>>
                        Religious</label></div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="political"
                            <?php echo in_array("political", $current_blacklist) ? " checked" : ""; ?>>
                        Political</label></div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="racist"
                            <?php echo in_array("racist", $current_blacklist) ? " checked" : ""; ?>> Racist</label>
                </div>
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="sexist"
                            <?php echo in_array("sexist", $current_blacklist) ? " checked" : ""; ?>> Sexist</label>
                </div>
                ...
                <div class="field"><label class="checkbox"><input type="checkbox" name="blacklist[]" value="explicit"
                            <?php echo in_array("explicit", $current_blacklist) ? " checked" : ""; ?>> Explicit</label>
                </div>
...
<div id="welcomeMessageModal" class="modal">
    <div class="modal-background"></div>
    <div class="modal-content" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('welcomeMessageModal')"
            style="position: absolute; top: 10px; right: 10px;"></button>
        <div class="box">
            <h2 class="title is-3 has-text-white">Custom Welcome Messages</h2>
            <form method="POST" action="module_data_post.php">
                <div class="notification is-info">
                    <strong>Info:</strong> You can use the <code>(user)</code> variable in the welcome message. It will
                    be replaced with the username of the user entering the chat.
                </div>
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="new_default_welcome_message"
                            value="<?php echo $new_default_welcome_message ? $new_default_welcome_message : '(user) is new to the community, let\'s give them a warm welcome!'; ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="has-text-white has-text-left">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="default_welcome_message"
                            value="<?php echo $default_welcome_message ? $default_welcome_message : 'Welcome back (user), glad to see you again!'; ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="has-text-white has-text-left">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="new_default_vip_welcome_message"
                            value="<?php echo $new_default_vip_welcome_message ? $new_default_vip_welcome_message : 'ATTENTION! A very important person has entered the chat, welcome (user)'; ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="has-text-white has-text-left">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="default_vip_welcome_message"
                            value="<?php echo $default_vip_welcome_message ? $default_vip_welcome_message : 'ATTENTION! A very important person has entered the chat, welcome (user)'; ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="has-text-white has-text-left">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="new_default_mod_welcome_message"
                            value="<?php echo $new_default_mod_welcome_message ? $new_default_mod_welcome_message : 'MOD ON DUTY! Welcome in (user), the power of the sword has increased!'; ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="has-text-white has-text-left">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="default_mod_welcome_message"
                            value="<?php echo $default_mod_welcome_message ? $default_mod_welcome_message : 'MOD ON DUTY! Welcome in (user), the power of the sword has increased!'; ?>">
                    </div>
                </div>
                <div class="field">
...
<div id="twitchAudioAlertsModal" class="modal">
    ...
    <div class="modal-content custom-width" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('twitchAudioAlertsModal')"
            style="position: absolute; top: 10px; right: 10px;"></button>
        <div class="box">
            ...
            <div class="columns is-desktop is-multiline box-container is-centered" style="width: 100%;">
                <div class="column is-4" id="walkon-upload" style="position: relative;">
                    ...
                    <div class="progress-bar-container">
                        <div id="uploadProgressBar" class="progress-bar has-text-black-bis"
                            style="width: <?php echo $storage_percentage; ?>%;">
                            <?php echo round($storage_percentage, 2); ?>%</div>
                    </div>
                    <p><?php echo round($current_storage_used / 1024 / 1024, 2); ?>MB of
                        <?php echo round($max_storage_size / 1024 / 1024, 2); ?>MB used</p>
                    <?php if (!empty($status)): ?>
                                ...
                                <tbody>
                                    <?php foreach ($walkon_files as $file): ?>
                                        <tr>
                                                ...
                                                <?php if (!empty($availableEvents) || !$current_reward_id): ?>
                                                    <form action="module_data_post.php" method="POST" class="mapping-form">
                                                        <input type="hidden" name="sound_file"
                                                            value="<?php echo htmlspecialchars($file); ?>">
                                                        <select name="twitch_alert_id" class="mapping-select"
                                            ...
                                            <td>
                                                <button type="button" class="delete-single button is-danger"
                                                    data-file="<?php echo htmlspecialchars($file); ?>">Delete</button>
                                            </td>
                                            <td>
                                                <button type="button" class="test-sound button is-primary"
                                                    data-file="<?php echo htmlspecialchars($file); ?>">Test</button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<div id="twitchChatAlertsModal" class="modal">
    <div class="modal-background"></div>
    <div class="modal-content custom-width" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('twitchChatAlertsModal')"
            style="position: absolute; top: 10px; right: 10px;"></button>
        <div class="box">
                ...
                <div class="column is-12" id="chat-alerts-settings" style="position: relative;">
                    <div class="notification is-info">
                        ...
                        <ul>
                            ...
                            <li><span class="has-text-weight-bold">(bits)</span> for the number of bits for the cheer
                                message.</li>
                            <li><span class="has-text-weight-bold">(viewers)</span> for the number of viewers in the
                                raid message.</li>
                            <li><span class="has-text-weight-bold">(tier)</span> for the subscription tier.</li>
                            <li><span class="has-text-weight-bold">(months)</span> for the number of months subscribed.
                            </li>
                            <li><span class="has-text-weight-bold">(count)</span> for the number of gifted
                                subscriptions.</li>
                    ...
                    <form action="module_data_post.php" method="POST" id="chatAlertsForm">
                        <div class="field">
                            ...
                            <div class="control"><input class="input" type="text" name="message_alert"
                                    value="Thank you (user) for following! Welcome to the channel!"></div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Cheer Alert</label>
                            <div class="control"><input class="input" type="text" name="command_alert"
                                    value="Thank you (user) for (bits) bits!"></div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Raid Alert</label>
                            <div class="control"><input class="input" type="text" name="mention_alert"
                                    value="Incredible! (user) and (viewers) viewers have joined the party! Let's give them a warm welcome!">
                            </div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Subscription Alert</label>
                            <div class="control"><input class="input" type="text" name="mention_alert"
                                    value="Thank you (user) for subscribing! You are now a (tier) subscriber for (months) months!">
                            </div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Gift Subscription Alert</label>
                            <div class="control"><input class="input" type="text" name="gift_subscription_alert"
                                    value="Thank you (user) for gifting a (tier) subscription to (count) members!">
                            </div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Hype Train Start</label>
                            <div class="control"><input class="input" type="text" name="hype_train_start"
                                    value="The Hype Train has started! Starting at level: (level)"></div>
                        </div>
                        <div class="field">
                            <label class="has-text-white has-text-left">Hype Train End</label>
                            <div class="control"><input class="input" type="text" name="hype_train_end"
                                    value="The Hype Train has ended at level (level)!"></div>
                        </div>
...
<div id="adNoticesModal" class="modal">
    <div class="modal-background"></div>
    <div class="modal-content" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('adNoticesModal')"
            style="position: absolute; top: 10px; right: 10px;"></button>
        <div class="box">
            ...
            <form method="POST" action="module_data_post.php">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="ad_start_message" placeholder="Message when ads start"
                            value="<?php echo htmlspecialchars($ad_start_message); ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="label">Ad Ended Message</label>
                    <div class="control">
                        <input class="input" type="text" name="ad_end_message" placeholder="Message when ads end"
                            value="<?php echo htmlspecialchars($ad_end_message); ?>">
                    </div>
                </div>
                <div class="field">
                    <label class="checkbox">
...
<div id="chatProtectionModal" class="modal">
    <div class="modal-background"></div>
    <div class="modal-content custom-width" style="position: relative;">
        <button class="modal-close is-large" aria-label="close" onclick="closeModal('chatProtectionModal')"
            style="position: absolute; top: 10px; right: 10px;"></button>
        <div class="box">
