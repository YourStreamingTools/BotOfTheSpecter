  ...
  <div class="column is-fullwidth">
    <div class="card has-background-dark has-text-white mb-5"
      ...
      <div class="card-content">
        ...
        <?php endif; ?>
        <p id="updateInfo" class="mb-3"><?php echo t('bot_points_data_last_updated'); ?> <span id="secondsAgo">0</span>
          <?php echo t('bot_points_seconds_ago'); ?></p>
                    ...
                    <form method="POST" action="" style="display:inline;">
                      ...
                      <div class="field has-addons is-flex is-justify-content-center is-align-items-center">
                        <div class="control"><input class="input" type="number" name="points"
                            value="<?php echo htmlspecialchars($row['points']); ?>" required style="width: 100px;"></div>
                        <div class="control" style="margin-left: 5px;"><button class="button is-primary" type="submit"
                            name="update_points"><?php echo t('bot_points_update_btn'); ?></button></div>
                        <div class="control" style="margin-left: 5px;"><button class="button is-danger" type="submit"
                            name="remove_user"><?php echo t('bot_points_remove_btn'); ?></button></div>
                      </div>
                    </form>
                  </td>
                </tr>
        ...
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="number" name="point_amount_chat"
              value="<?php echo htmlspecialchars($settings['point_amount_chat']); ?>" required>
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="number" name="point_amount_follower"
              value="<?php echo htmlspecialchars($settings['point_amount_follower']); ?>" required>
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="number" name="point_amount_subscriber"
              value="<?php echo htmlspecialchars($settings['point_amount_subscriber']); ?>" required>
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="number" name="point_amount_cheer"
              value="<?php echo htmlspecialchars($settings['point_amount_cheer']); ?>" required>
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="number" name="point_amount_raid"
              value="<?php echo htmlspecialchars($settings['point_amount_raid']); ?>" required>
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <div class="select is-fullwidth">
              <select name="subscriber_multiplier">
                <option value="0" <?php echo $settings['subscriber_multiplier'] == 0 ? 'selected' : ''; ?>>
