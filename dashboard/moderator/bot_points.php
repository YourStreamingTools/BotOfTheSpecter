...
$pointAmountChat = $settings['point_amount_chat'];
$pointAmountFollower = $settings['point_amount_follower'];
$pointAmountSubscriber = $settings['point_amount_subscriber'];
$pointAmountCheer = $settings['point_amount_cheer'];
$pointAmountRaid = $settings['point_amount_raid'];
$subscriberMultiplier = $settings['subscriber_multiplier'];
