      ...
      <div class="card-content">
        ...
        <div id="view-mode" class="mode-content">
          <div class="buttons is-centered mb-4 is-flex-wrap-wrap">
            <button class="button is-info" data-type="lurkers"
              onclick="loadData('lurkers')"><?php echo t('counters_lurkers'); ?></button>
            <button class="button is-info" data-type="typos"
              onclick="loadData('typos')"><?php echo t('edit_counters_edit_user_typos'); ?></button>
            <button class="button is-info" data-type="deaths"
              onclick="loadData('deaths')"><?php echo t('counters_deaths'); ?></button>
            <button class="button is-info" data-type="hugs"
              onclick="loadData('hugs')"><?php echo t('counters_hugs'); ?></button>
            <button class="button is-info" data-type="kisses"
              onclick="loadData('kisses')"><?php echo t('counters_kisses'); ?></button>
            <button class="button is-info" data-type="highfives"
              onclick="loadData('highfives')"><?php echo t('counters_highfives'); ?></button>
            <button class="button is-info" data-type="customCounts"
              onclick="loadData('customCounts')"><?php echo t('counters_custom_counts'); ?></button>
            <button class="button is-info" data-type="userCounts"
              onclick="loadData('userCounts')"><?php echo t('counters_user_counts'); ?></button>
            <button class="button is-info" data-type="rewardCounts"
              onclick="loadData('rewardCounts')"><?php echo t('counters_reward_counts'); ?></button>
            <button class="button is-info" data-type="rewardStreaks"
              onclick="loadData('rewardStreaks')"><?php echo t('counters_reward_streaks'); ?></button>
            <button class="button is-info" data-type="rewardUsage"
              onclick="loadData('rewardUsage')"><?php echo t('counters_reward_usage'); ?></button>
            <button class="button is-info" data-type="watchTime"
              onclick="loadData('watchTime')"><?php echo t('counters_watch_time'); ?></button>
            <button class="button is-info" data-type="quotes"
              onclick="loadData('quotes')"><?php echo t('counters_quotes'); ?></button>
          </div>
          <div class="content">
        ...
        <div id="edit-mode" class="mode-content" style="display: none;">
          <div class="buttons is-centered mb-4 is-flex-wrap-wrap">
            <button class="button is-info" data-edit-type="typos"
              onclick="showEditTab('typos')"><?php echo t('edit_counters_edit_user_typos'); ?></button>
            <button class="button is-info" data-edit-type="customCounts"
              onclick="showEditTab('customCounts')"><?php echo t('counters_custom_counts'); ?></button>
            <button class="button is-info" data-edit-type="deaths"
              onclick="showEditTab('deaths')"><?php echo t('counters_deaths'); ?></button>
            <button class="button is-info" data-edit-type="hugs"
              onclick="showEditTab('hugs')"><?php echo t('counters_hugs'); ?></button>
            <button class="button is-info" data-edit-type="kisses"
              onclick="showEditTab('kisses')"><?php echo t('counters_kisses'); ?></button>
            <button class="button is-info" data-edit-type="highfives"
              onclick="showEditTab('highfives')"><?php echo t('counters_highfives'); ?></button>
            <button class="button is-info" data-edit-type="userCounts"
              onclick="showEditTab('userCounts')"><?php echo t('counters_user_counts'); ?></button>
            <button class="button is-info" data-edit-type="quotes"
              onclick="showEditTab('quotes')"><?php echo t('counters_quotes'); ?></button>
          </div>
          <!-- Typos Edit Tab -->
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="typo-edit-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="typo-remove-form" data-type="typo">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="typo-remove-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                        ...
                        <div class="select is-fullwidth">
                          <select id="command" name="command" required
                            ...
                            <?php foreach ($commands as $cmd): ?>
                              <option value="<?php echo htmlspecialchars($cmd); ?>"><?php echo htmlspecialchars($cmd); ?>
                              </option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="command-edit-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="command-remove-form">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="command-remove-btn"
          ...
          <div id="edit-tab-deaths" class="edit-tab-content" style="display:none;">
            <div class="notification is-info has-text-centered mb-4">
              ...
              <span id="edit-total-deaths"
                class="has-text-weight-bold has-text-danger"><?php echo (int) $totalDeaths; ?></span>
            </div>
            <div class="columns is-desktop is-multiline">
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="death-edit-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="death-remove-form">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="death-remove-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                          ...
                          <select id="hug-username" name="hug-username" required
                            ...
                            <?php foreach ($hugUsers as $user): ?>
                              <option value="<?php echo htmlspecialchars($user); ?>">
                                <?php echo htmlspecialchars($user); ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="hug-edit-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="hug-remove-form">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="hug-remove-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="kiss-edit-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="kiss-remove-form">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="kiss-remove-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="highfive-edit-btn"
                ...
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="highfive-remove-form">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="highfive-username-remove" name="highfive-username-remove" required
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="highfive-remove-btn"
              ...
              <div class="column is-6">
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="usercount-command" name="usercount-command" required
                            onchange="updateUserCountUsers(this.value); enableButton('usercount-command','usercount-edit-btn');">
                            <option value=""><?php echo t('edit_counters_select_command'); ?></option>
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="usercount-user" name="usercount-user" required
                            onchange="updateUserCountValue(); enableButton('usercount-user','usercount-edit-btn');">
                            <option value=""><?php echo t('edit_counters_select_user'); ?></option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="usercount-edit-btn"
                          disabled><?php echo t('edit_counters_update_btn'); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="usercount-remove-form">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="usercount-command-remove" name="usercount-command-remove" required
                            onchange="updateUserCountUsersRemove(this.value); enableButton('usercount-command-remove','usercount-remove-btn');">
                            <option value=""><?php echo t('edit_counters_select_command'); ?></option>
                            <?php foreach ($userCountCommands as $cmd): ?>
                              <option value="<?php echo htmlspecialchars($cmd); ?>"><?php echo htmlspecialchars($cmd); ?>
                              </option>
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="usercount-user-remove" name="usercount-user-remove" required
                            onchange="enableButton('usercount-user-remove','usercount-remove-btn');">
                            <option value=""><?php echo t('edit_counters_select_user'); ?></option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="usercount-remove-btn"
                          disabled><?php echo t('edit_counters_remove_btn'); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <textarea class="textarea" name="quote_text" rows="3" required
                          placeholder="<?php echo t('edit_counters_quote_placeholder'); ?>"></textarea>
                      </div>
                    </div>
                    <div class="field">
                      <div class="control">
                        <button type="submit"
                          class="button is-success"><?php echo t('edit_counters_add_quote_btn'); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="quote-id" name="quote_id" required
                            onchange="updateQuoteText(this.value); enableButton('quote-id','quote-edit-btn');">
                            ...
                            <?php foreach ($quotesData as $quote): ?>
                              <option value="<?php echo htmlspecialchars($quote['id']); ?>">
                                ...
                                <?php echo htmlspecialchars(substr($quote['quote'], 0, 50)); ?>  <?php echo strlen($quote['quote']) > 50 ? '...' : ''; ?>
                              </option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-primary" id="quote-edit-btn"
                ...
                <div class="box has-background-dark">
                  ...
                  <form action="" method="post" id="quote-remove-form">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth">
                          <select id="quote-id-remove" name="quote_id" required
                            onchange="enableButton('quote-id-remove','quote-remove-btn');">
                            <option value=""><?php echo t('edit_counters_select_quote'); ?></option>
                            <?php foreach ($quotesData as $quote): ?>
                              <option value="<?php echo htmlspecialchars($quote['id']); ?>">
                                #<?php echo htmlspecialchars($quote['id']); ?> -
                    ...
                    <div class="field">
                      <div class="control">
                        <button type="submit" class="button is-danger" id="quote-remove-btn"
