...
if (!isset($pageTitle))
    $pageTitle = "BotOfTheSpecter Moderator";
if (!isset($pageDescription))
    $pageDescription = "BotOfTheSpecter Moderator Dashboard";
...
<head>
    ...
    <title>BotOfTheSpecter - <?php echo isset($pageTitle) ? $pageTitle : 'Moderator - BotOfTheSpecter Dashboard'; ?>
    </title>
    <!-- Bulma CSS 1.0.0 -->
...
<body class="page-wrapper">
    ...
    <div id="mobileMenu" class="mobile-menu" aria-hidden="true">
        ...
        <div class="mobile-menu-body" style="padding:0.75rem; overflow-y:auto; max-height:calc(100vh - 56px);">
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item has-submenu">
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="commands.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_view_custom_commands'); ?></a></li>
                        <li><a href="builtin.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_view_builtin_commands'); ?></a></li>
                        <li><a href="manage_custom_commands.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_edit_custom_commands'); ?></a></li>
                    </ul>
                </li>
                <li class="sidebar-menu-item">
                ...
                <li class="sidebar-menu-item has-submenu">
                    <a href="#" role="button" aria-expanded="false" class="sidebar-menu-link"
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="counters.php" class="sidebar-submenu-link"><?php echo t('navbar_counters'); ?></a>
                        </li>
                        <li><a href="edit_counters.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_edit_counters'); ?></a></li>
                    </ul>
                </li>
                <li class="sidebar-menu-item">
                ...
                <li class="sidebar-menu-item has-submenu">
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="sound-alerts.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_sound_alerts'); ?></a></li>
                        <li><a href="video-alerts.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_video_alerts'); ?></a></li>
                        <li><a href="walkons.php"
                                class="sidebar-submenu-link"><?php echo t('navbar_walkon_alerts'); ?></a></li>
                    </ul>
                </li>
            </ul>
    ...
    ?>
    <div
        style="background:rgb(0, 123, 255); color: #fff; font-weight: bold; text-align: center; padding: 0.75rem 1rem; letter-spacing: 0.5px;">
        <?php if ($modDisplay || $modUsername): ?>
            <span>
                You are moderating:
                <strong><?php echo $modDisplay ? $modDisplay : $modUsername; ?></strong><?php echo ($modDisplay && $modUsername) ? ' (@' . $modUsername . ')' : ''; ?>
            </span>
        <?php else: ?>
            <span>
                You are using the <strong>MODERATOR</strong> dashboard. No channel selected —
                <a href="../mod_channels.php" style="color:#fff; text-decoration:underline;">select a channel to
                    moderate</a>.
            </span>
        <?php endif; ?>
    </div>
    ...
    <aside class="sidebar-nav desktop-only" id="sidebarNav">
        ...
        <div class="sidebar-content-wrapper">
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item has-submenu">
                    <a href="#" class="sidebar-menu-link <?php echo $active_menu == 'commands' ? 'active' : ''; ?>"
                        onclick="toggleSubmenu(event, this)">
                        <span class="sidebar-menu-icon"><i class="fas fa-terminal"></i></span>
                        <span class="sidebar-menu-text"><?php echo t('navbar_commands'); ?></span>
                        <span class="sidebar-submenu-toggle"><i class="fas fa-chevron-down"></i></span>
                ...
                <li class="sidebar-menu-item">
                    <a href="timed_messages.php"
                        class="sidebar-menu-link <?php echo $active_menu == 'timed_messages' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="fas fa-clock"></i></span>
                        <span class="sidebar-menu-text"><?php echo t('navbar_timed_messages'); ?></span>
                    </a>
                ...
                <li class="sidebar-menu-item">
                    <a href="bot_points.php"
                        class="sidebar-menu-link <?php echo $active_menu == 'points' ? 'active' : ''; ?>">
                        <span class="sidebar-menu-icon"><i class="fas fa-coins"></i></span>
                        <span class="sidebar-menu-text"><?php echo t('navbar_points_system'); ?></span>
                    </a>
                ...
                <li class="sidebar-menu-item has-submenu">
                    <a href="#" class="sidebar-menu-link <?php echo $active_menu == 'counters' ? 'active' : ''; ?>"
                        onclick="toggleSubmenu(event, this)">
                        <span class="sidebar-menu-icon"><i class="fas fa-calculator"></i></span>
                        <span class="sidebar-menu-text"><?php echo t('navbar_counters'); ?></span>
                        <span class="sidebar-submenu-toggle"><i class="fas fa-chevron-down"></i></span>
                ...
                <li class="sidebar-menu-item has-submenu">
                    <a href="#" class="sidebar-menu-link <?php echo $active_menu == 'alerts' ? 'active' : ''; ?>"
                        onclick="toggleSubmenu(event, this)">
                        <span class="sidebar-menu-icon"><i class="fas fa-bell"></i></span>
                        <span class="sidebar-menu-text"><?php echo t('navbar_alerts'); ?></span>
                        <span class="sidebar-submenu-toggle"><i class="fas fa-chevron-down"></i></span>
