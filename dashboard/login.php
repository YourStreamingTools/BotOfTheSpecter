...
$IDScope = 'openid channel:bot channel:moderate user:edit:broadcast channel:read:hype_train channel:manage:polls channel:manage:redemptions channel:manage:broadcast moderator:read:vips moderator:read:moderators channel:read:charity user:read:email user:read:chat user:write:chat user:read:follows moderator:manage:shoutouts chat:read chat:edit moderation:read moderator:read:followers channel:read:redemptions channel:read:vips channel:manage:vips channel:read:subscriptions moderator:read:chatters bits:read channel:manage:ads channel:read:ads channel:manage:schedule clips:edit moderator:manage:announcements moderator:manage:banned_users moderator:manage:unban_requests moderator:manage:chat_settings moderator:manage:blocked_terms moderator:manage:chat_messages moderator:read:shoutouts moderator:manage:shoutouts user:read:blocked_users user:manage:blocked_users';
