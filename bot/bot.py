...
builtin_commands = {"commands", "bot", "timer", "ping", "lurk", "unlurk", "lurking", "lurklead", "hug", "kiss", "uptime", "typo", "typos", "followage", "so"}
mod_commands = {"addcommand", "removecommand", "removetypos", "edittypos"}
