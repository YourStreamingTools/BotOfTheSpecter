...
async def refresh_token(session, pool, twitch_user_id, refresh_token_value):
    data = { 'grant_type': 'refresh_token', 'client_id': CLIENT_ID, 'client_secret': CLIENT_SECRET, 'refresh_token': refresh_token_value}
...
async def main():
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            tasks = [refresh_token(session, pool, twitch_user_id, refresh_token_val) for twitch_user_id, refresh_token_val in tokens]
